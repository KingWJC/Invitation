      ...
      <div class="invitation-cover">
        <div class="cover-content" :class="{'invitation-up':isOpening}">
          <div class="content-inside">
            ...
            <p>🐱是，髣髴兮若轻云之蔽月，飘飖兮若流风之回雪。</p>
            <p>🐷是，言念君子，温其如玉。</p>
            <p><b>人海茫茫，你会遇到各种各样的人，而我想成为你生命中最特别的那一个</b></p>
            ...
            <div class="content-inside-bless">
              <input
                ...
                ref="wishInput"
              >
              <p v-if="!wish && isFocused && hasEntered">请写下你的回复</p>
              <div>
                <button @click="sendBarrage">保存</button>
...
export default {
  ...
  data() {
    return {
      ...
      isFocused: false,
      hasEntered: false,
      year: moment('2020-10-24').toNow(true)
    }
  },
  methods: {
    // 打开邀请函
